...
class IrqHandler:
    ...
    def __init__(self,schedullingPolitic):
        self.irqs=[]
        self.routines=[RoutineKill(),RoutineTimeout(),RoutineNewprocess(),RoutineIO(),RoutineIOFinish()]#falta la de page
    ...
    def handle(self,irq): #falta la memoria
        self.put(irq)
        self.anyRoutineHandle(irq)
